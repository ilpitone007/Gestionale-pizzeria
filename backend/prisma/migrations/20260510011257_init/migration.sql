...
CREATE TABLE "pizza_ingredienti" (
    ...
    CONSTRAINT "pizza_ingredienti_pizzaId_fkey" FOREIGN KEY ("pizzaId") REFERENCES "pizze" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "pizza_ingredienti_ingredienteId_fkey" FOREIGN KEY ("ingredienteId") REFERENCES "ingredienti" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
