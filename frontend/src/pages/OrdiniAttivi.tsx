    ...
    const html = `
      ...
      <body>
        <div class="header">
          ...
          <div>${tipo === 'cucina' ? '<strong>COMANDA CUCINA</strong>' : '<strong>RICEVUTA NON FISCALE</strong>'}</div>
          ${operatore ? `<div style="margin-top: 5px;">Op: ${operatore.nome}</div>` : ''}
        </div>
        ...
        <div class="footer">
          ...
          ${operatore ? `<br/><br/>Operatore: ${operatore.nome} ${operatore.cognome}` : ''}
        </div>
        <script>
              ...
              <div className="p-4 border-b bg-gray-50 flex justify-between items-start">
                <div>
                  <div className="text-sm text-gray-500 mb-1 flex items-center gap-2">
                    <span>Ordine #{ordine.numeroOrdine} • {ordine.voci.length} pizze</span>
                    {ordine.operatore && (
